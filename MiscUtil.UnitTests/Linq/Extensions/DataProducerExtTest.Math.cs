...
namespace MiscUtil.UnitTests.Linq.Extensions
{
    public partial class DataProducerExtTest
    {
        ...
        {
            IFuture<string> sum;
            Assert.Throws<ArgumentNullException> (() => sum = NullDataProducer.Sum());
        }
        ...
        {
            IFuture<int> sum;
           Assert.Throws<ArgumentNullException> (() => sum = NullDataProducer.Sum(x => int.Parse(x)));
        }
        ...
        public void SumNullProjection()
        {
            ...
            IFuture<int> sum;
            Assert.Throws<ArgumentNullException>(() => sum = prod.Sum(projection));
        }
        ...
        {
            IFuture<string> avg;
            Assert.Throws<ArgumentNullException>(() => avg = NullDataProducer.Average());
        }
        ...
        {
            IFuture<double> avg;
            Assert.Throws<ArgumentNullException>(() => avg = NullDataProducer.Average(x => int.Parse(x)));
        }
