...
namespace MiscUtil.UnitTests
{
    ...
    public class CachingBufferManagerTest
    {
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => options.MaxBufferSize = 0);
        }
        ...
        {
           Assert.Throws<ArgumentOutOfRangeException> (() => options.MinBufferSize = 0);
        }
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => options.MaxBuffersPerSizeBand = 0);
        }
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException> (() => options.ScalingFactor = 1.24);
        }
        ...
        public void MinBufferSizeCannotBeMoreThanMaxBufferSizeOnManagerConstruction()
        {
            ...
            Assert.Throws<ArgumentException>(() => new CachingBufferManager(options));
        }
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => options.ActionOnBufferUnavailable = (CachingBufferManager.Options.BufferUnavailableAction) 17);
        }
